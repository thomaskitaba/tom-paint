...
def undo_last_cont_circle(a):
			pass
def undo_last_circle(a):
			pass
def  undo_last_rectangle(a):
			pass
...
#undo_cont_line_coordinate = []
	...
	#--------------------------------------------	
				if shape_mode_rectangle :
					...
					for i in range(10):
						if len(undo_rectangle_coordinate):
...
#=========  RECTANGLE =============
		if pygame.mouse.get_pressed()[0] and shape_mode_rectangle ==  True and mousey <= screen_height - 230 and mousey >= ot +  color_pallet_size:
			...
			p = width
			q = height
			undo_rectangle_coordinate = [x, y, p, q]
