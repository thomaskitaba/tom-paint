...
#what_color_coord_center[0] = color_blue.cente
			...
			if distance_with_circle_icon <= color_pallet_size:
					...
					#shape_coordinate_continious[1] = paint_coordinate_continious[0][1]
					
				#paint_coordinate_continious[0][0] = shape_coordinate_continious[0]
				#paint_coordinate_continious[0][1] = shape_coordinate_continious[0]
			#	cleared = False
				
				#paint_coordinate_continious.clear()
				erase_mode = False
				paint_mode = False
				shape_mode_line = False
				shape_mode_line_continious = False
...
#==================================		
		...
		if event.type == pygame.MOUSEBUTTONUP and shape_mode_line_continious:
			paint_coordinate_line_continious.clear()	
